...
cd ..
curl -X GET --output temp_osd.tar.gz https://artifacts.opensearch.org/snapshots/core/opensearch-dashboards/1.1.0-SNAPSHOT/opensearch-dashboards-min-1.1.0-SNAPSHOT-linux-x64-latest.tar.gz
